...
class son(parent):
    def __init__(self, total_asset, pecentage_for_son):
        super().__init__(total_asset)
        self.percentage_for_son = pecentage_for_son

    def son_display(self):
        print("Share of Son is " + str(round(self.percentage_for_son / self.total_asset, 2)) + " Million.")


class daughter(parent):
    def __init__(self, total_asset, pecentage_for_daughter):
        super().__init__(total_asset)
        self.pecentage_for_daughter = pecentage_for_daughter

    def daughter_display(self):
        print("Share of Daughter is " + str(round(self.pecentage_for_daughter / self.total_asset, 2)) + " Million.")
